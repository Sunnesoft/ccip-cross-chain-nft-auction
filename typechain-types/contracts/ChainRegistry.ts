...
export interface ChainRegistryInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "acceptOwnership"
      | "hasPermission"
...
export interface ChainRegistry extends BaseContract {
  connect(runner?: ContractRunner | null): ChainRegistry;
  waitForDeployment(): Promise<this>;

  interface: ChainRegistryInterface;
